...
import Navbar from "@/components/manager/globals/Navbar";
import Sidebar from "@/components/manager/globals/Sidebar";
import MobileSidebar from "@/components/manager/globals/MobileSidebar";
...
export default function ManagerLayout({
  ...
  const checkAuth = async () => {
    ...
    if (res?.data?.role_id?.role_name?.toLowerCase() === "manager") {
      setLoading(false);
    } else {
